      ...
      <div className="min-h-screen bg-white">
        ...
        {location.pathname !== '/pyydä_leimakortti' && (
          <button
            ...
            className="fixed top-4 right-4 z-50 bg-orange-500 text-white px-4 py-2 rounded-full shadow-lg hover:bg-orange-600 transition-all duration-300 flex items-center space-x-2 font-bold text-sm"
          >
